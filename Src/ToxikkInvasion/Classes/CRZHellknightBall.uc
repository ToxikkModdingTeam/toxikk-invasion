class CRZHellknightBall extends CRZDoomProjectile;

defaultproperties
{
	ProjectileLightClass=Class'CRZHellknightLight'
	ExplosionLightClass=Class'CRZHellknightLightBoom'
	...
	MyDamageType=Class'CRZDmgType_HellknightBall'
}