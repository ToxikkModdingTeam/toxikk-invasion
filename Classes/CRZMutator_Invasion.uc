...
var 			array< Class<ToxikkMonster> >		RealMonsterTypes;
var 			array< Class<ToxikkMonster> >		RealBossTypes;
...
simulated function PostBeginPlay()
{
	...
	{
		RealMonsterTypes[l] = Class<ToxikkMonster>(DynamicLoadObject(MonsterTypes[l], Class'Class'));
	}
	
	for (l=0; l<BossTypes.Length; l++)
	{
		RealBossTypes[l] = Class<ToxikkMonster>(DynamicLoadObject(BossTypes[l], Class'Class'));
	}
...
simulated function SpawnMonsters()
{
	...
	ForEach DynamicActors(Class'ToxikkMonster',CRZ)
	{
		Total ++;
	}
